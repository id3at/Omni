...
impl AudioGraph {
    ...
    pub fn process_overlay(&mut self, nodes: &[NodeIndex], buffers: &mut [Vec<f32>], events: &[Vec<MidiNoteEvent>], sample_rate: f32) {
